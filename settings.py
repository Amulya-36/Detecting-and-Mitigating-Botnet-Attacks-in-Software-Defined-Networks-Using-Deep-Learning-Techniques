...
ROOT_URLCONF = 'detecting_and_mitigating_botnet_attacks.urls'
...
WSGI_APPLICATION = 'detecting_and_mitigating_botnet_attacks.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'detecting_and_mitigating_botnet_attacks',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',

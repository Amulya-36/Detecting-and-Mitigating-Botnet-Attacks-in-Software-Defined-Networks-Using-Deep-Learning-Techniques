...
--
-- Host: localhost
-- Generation Time: Nov 09, 2023 at 02:32 PM
...
--
-- Database: `detecting_and_mitigating_botnet_attacks`
--
CREATE DATABASE IF NOT EXISTS `detecting_and_mitigating_botnet_attacks` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `detecting_and_mitigating_botnet_attacks`;
...
('2zh364lz6if2ptx12n8hesnfe6v0zhps', 'eyJ1c2VyaWQiOjJ9:1nkLkq:qGX2ARhiXlqCMus9FTQ-mwiWyaW_uy9T3uB_IM14_PM', '2022-05-13 08:13:32.867852'),
...
('eeqvotdnk45d5hc1908x3yb4bzi8wqy4', 'eyJ1c2VyaWQiOjN9:1oIodJ:Eo2OhCIB8KXJ8WAbZ7HKoYcx2LQEj-FsNqMWtaEXax8', '2022-08-16 09:56:13.551077'),
...
('kllgqu40nn3q6gm1bmn0t3wazd2nvtis', 'eyJ1c2VyaWQiOjE5fQ:1mBcS8:Mi-b7WwAy7FSZJlqhCmDNFLz-lYfcbkcjSm3_qA0Mqw', '2021-08-19 12:26:24.618162'),
('l1xjz2wffaumok3yr9wypufo3d7cpitb', 'eyJ1c2VyaWQiOjJ9:1qpnjM:YpWaDwN50wjLTyxZB-ZsVY0B37gwRopUY1pp_2v2eQs', '2023-10-23 10:43:20.517002'),
...
('omzwvxqfurhnuhtyr9gvr31iz8ynutec', 'eyJ1c2VyaWQiOjJ9:1nFZBf:yi-c-MxMaeDoZdtQ4KueqMkcLiwTM1k_diS2fGY6UWI', '2022-02-17 10:17:59.037466'),
('p16ykxk32bq067zrvhoyi8hjwuesj1dz', 'eyJ1c2VyaWQiOjE5fQ:1mD5d1:g11nV72Krg4LgeV3E52Gb0JeKRtzF9TM3NnKGZ7ImKo', '2021-08-23 13:47:43.458749'),
('pnujgok0295m5s971skl0kq77w9dcr7a', 'eyJ1c2VyaWQiOjJ9:1nOf0y:lUokjf5YuhGMiVrYlhcYSMFLgJ67A6JnMyG0VHcQwxQ', '2022-03-14 12:20:32.060986'),
...
('uklxgz5rdpgdj2kt7qucj2s0fpo9mmjd', 'eyJ1c2VyaWQiOjR9:1oIpIK:agzYSyn9o72COQs7YT-72ftdKJJ4mhcAD6VkBJ3wj6c', '2022-08-16 10:38:36.729597'),
('v3weefj82tze2lwp7sb8qa3b60iupaqe', 'eyJ1c2VyaWQiOjF9:1nOcpA:ik2WwGEeAfvmTVfZxksSD3Ecuku208cYYppqcRVcAFU', '2022-03-14 10:00:12.112384'),
('v8t0hboua51qsq6fpdwqlm1rceh8f9d3', 'eyJ1c2VyaWQiOjEwfQ:1mBa5r:9nuYjsPZvQdmJXSF4v80VjKiz8uPTfaIy61fbD0yt-0', '2021-08-19 09:55:15.896917'),
...
('x5wyplbsnfiwj5hyhnsv4ddlb09xind0', 'eyJ1c2VyaWQiOjF9:1qpnGW:zq3UJGPKoNdmfTkLLwqSd_HYGbXeS6bdN2Qk_hq71LY', '2023-10-23 10:13:32.888931'),
...
(1, 'Harish', 'Harish123@gmail.com', 'Harish', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju14@gmailo.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male');
...
(5, 'Convolutional Neural Network (CNN)', '50.743801652892564'),
(6, 'Gradient Boosting Classifier', '56.85950413223141');
...
(13, 'Botnet Attack Not Found', '33.33333333333333'),
(14, 'Botnet Attack Found', '66.66666666666666');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_prediction_botnet_attack`
--

CREATE TABLE IF NOT EXISTS `remote_user_prediction_botnet_attack` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `stime` varchar(300) NOT NULL,
  `flgs_number` varchar(300) NOT NULL,
  `proto` varchar(300) NOT NULL,
  `proto_number` varchar(300) NOT NULL,
  `saddr` varchar(300) NOT NULL,
  `sport` varchar(300) NOT NULL,
  `daddr` varchar(300) NOT NULL,
  `dport` varchar(300) NOT NULL,
  `pkts` varchar(300) NOT NULL,
  `bytes1` varchar(300) NOT NULL,
  `state` varchar(300) NOT NULL,
  `state_number` varchar(300) NOT NULL,
  `ltime` varchar(300) NOT NULL,
  `seq` varchar(300) NOT NULL,
  `duration` varchar(300) NOT NULL,
  `spkts` varchar(300) NOT NULL,
  `dpkts` varchar(300) NOT NULL,
  `sbytes` varchar(300) NOT NULL,
  `dbytes` varchar(300) NOT NULL,
  `rate` varchar(300) NOT NULL,
  `srate` varchar(300) NOT NULL,
  `drate` varchar(300) NOT NULL,
  `webcategory` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;

--
-- Dumping data for table `remote_user_prediction_botnet_attack`
--

INSERT INTO `remote_user_prediction_botnet_attack` (`id`, `Fid`, `stime`, `flgs_number`, `proto`, `proto_number`, `saddr`, `sport`, `daddr`, `dport`, `pkts`, `bytes1`, `state`, `state_number`, `ltime`, `seq`, `duration`, `spkts`, `dpkts`, `sbytes`, `dbytes`, `rate`, `srate`, `drate`, `webcategory`, `Prediction`) VALUES
(1, '10.42.0.42-23.217.155.120-47333-80-6', '1528088522', '1', 'tcp', '1', '192.168.100.147', '49978', '192.168.100.7', '80', '8', '2300', 'RST', '1', '1528088529', '19', '7.041316', '5', '3', '970', '1330', '0.994132', '0.568076', '16.451698', 'HTTP', 'Botnet Attack Found'),
(2, '10.42.0.211-104.192.110.245-33529-80-6', '1528088522', '1', 'tcp', '1', '192.168.100.147', '49988', '192.168.100.7', '80', '8', '2172', 'RST', '1', '1528088529', '24', '7.038965', '5', '3', '842', '1330', '0.994464', '0.568265', '0.811369', 'HTTP', 'Botnet Attack Not Found'),
(3, '10.42.0.151-10.42.0.1-21052-53-17', '1528088522', '1', 'tcp', '1', '192.168.100.147', '50100', '192.168.100.7', '80', '8', '2048', 'RST', '1', '1528088529', '80', '7.004942', '5', '3', '718', '1330', '0.999295', '0.571025', '0.33588', 'HTTP', 'Botnet Attack Found');
